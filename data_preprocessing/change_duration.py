...
def change_duration(input_audio_file, output_audio_file, duration_scaling_factor):
    """
    ...
    y_stretched = librosa.effects.time_stretch(y, rate = duration_scaling_factor)
...
change_duration(input_audio_file, output_audio_file, duration_scaling_factor)
