...
class phoneme_decoder(nn.Module):
    def __init__(self, query_dim, memory_dim, attention_dim,
                 attention_location_n_filters, attention_location_kernel_size, query, memory, attention_weights_cum, hidden_size, dropout):
        ## params
        ...
        self.query, self.memory, self.attention_weights_cum = query, memory, attention_weights_cum,
        ...
        ## layers
        self.attention = Attention(query_dim, memory_dim, attention_dim,
                                   attention_location_n_filters, attention_location_kernel_size)
        self.gru = nn.GRU(hidden_size=hidden_size, dropout=dropout)
    
    def forward(self, query, memory, attention_weights_cum, mask=None):
        attention_context, attention_weights = self.attention(query, memory, attention_weights_cum, mask)
